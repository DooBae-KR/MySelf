...
import { myInfo,myWorkSkill,myLicense,myQr,myCompuSkill } from "../data/MyInform"
        ...
        <div>
            ...
            <div ref={pdfRef} className="A4 rec">
                ...
                <div className="container content">
                    <div className="contentTitle">Personal Information</div>
                    ...
                    <div className="container">
                        <div className="container col">
                            <div className="contentTitle">CARRER</div>
                        ...
                        <div className="container col">
                            <div className="contentTitle">MY SKILL</div>
                            <dvi className="context">
                                {myCompuSkill.map((item,index)=>{
                            ...
                            <div className="contentTitle">PROJECT QR</div>
                            <div className="context">
                                {myQr.map((item,index)=>(
                                    <div key={index} className="work-item" >
                            ...
                            <div className="contentTitle">LICENSE</div>
                            <div className="context">
                                {myLicense.map((item,index)=>(
                                    <div key={index} className="work-item" style={{ marginBottom: "20px" }}>
                                    <pre><strong>· {item.name}</strong>( 취득일 : {item.date} )</pre>
                                    </div>
                                ))}
                            </div>
                        </div>
